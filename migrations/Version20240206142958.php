 ...
 */
final class Version20240206142958 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE media (id INT AUTO_INCREMENT NOT NULL, article_id INT DEFAULT NULL, image_name VARCHAR(255) DEFAULT NULL, cree_le DATETIME NOT NULL, modifie_le DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', legende VARCHAR(255) DEFAULT NULL, INDEX IDX_6A2CA10C7294869C (article_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
